...
BEGIN
	...
	BEGIN TRY
		...
		SET @start_time = GETDATE();
		PRINT '>>Truncating Table: bronze.erp_px_cat_gv1v2';
		TRUNCATE TABLE bronze.erp_px_cat_gv1v2;

		PRINT '>>Inserting Data Into:bronze.erp_px_cat_gv1v2';
		BULK INSERT bronze.erp_px_cat_gv1v2
